...
correct_credentials = correct_username == username_input and admin_username == username_input 
admin_credentials = correct_password == password_input and admin_password == password_input
