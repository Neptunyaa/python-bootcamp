...
correct_credentials = correct_username == username_input and correct_password == password_input
admin_credentials = admin_password == password_input and admin_username == username_input 
